...
////        onView(withId(R.id.makeEditText)).perform(ViewActions.typeText("make"), ViewActions.closeSoftKeyboard());
////        onView(withId(R.id.makeModel)).perform(ViewActions.typeText("model"), ViewActions.closeSoftKeyboard());
////        onView(withId(R.id.makeValue)).perform(ViewActions.typeText("1234"), ViewActions.closeSoftKeyboard());
////        onView(withId(R.id.makeSN)).perform(ViewActions.typeText("1a2s3d4f"), ViewActions.closeSoftKeyboard());
////        onView(withId(R.id.makeDesc)).perform(ViewActions.typeText("description"), ViewActions.closeSoftKeyboard());
////        onView(withId(R.id.makeComment)).perform(ViewActions.typeText("comment"), ViewActions.closeSoftKeyboard());
...
//
//        onView(withId(R.id.makeSN)).perform(ViewActions.typeText("Sample SN"), ViewActions.closeSoftKeyboard());

...
public class andresTestFile {
    ...
    public void testEditThenConfirm() {
        ...
        onView(withId(R.id.makeValue)).perform(ViewActions.typeText("88"), ViewActions.closeSoftKeyboard());
        onView(withId(R.id.makeText)).perform(ViewActions.typeText("Edited Make"), ViewActions.closeSoftKeyboard());
        onView(withId(R.id.makeModel)).perform(ViewActions.typeText("Edited Model"), ViewActions.closeSoftKeyboard());
        onView(withId(R.id.makeSN)).perform(typeText("Edited SN"), closeSoftKeyboard());
        onView(withId(R.id.makeComment)).perform(typeText("Edited Comment"), closeSoftKeyboard());
        onView(withId(R.id.makeDesc)).perform(typeText("Edited Description"), closeSoftKeyboard());
        onView(withText("Confirm")).perform(click());
        // navigate back
